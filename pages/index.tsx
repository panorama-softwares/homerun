  ...
  return (
    ...
    backgroundImage: `url('./back.png')`,
     height: "900",
        ...
        <div className="flex flex-col sm:pb-5">
      ...
      <body>
        ...
        <div className="container flex flex-row bg-white flex-wrap h-fit w-100 ml-20 py-2 mb-28 sm:justify-center sm:items-center md:justify-items-center md:items-center sm:flex-col md:flex-row lg:flex-row">

          <div className="bg-white md:basis-1/2  lg:basis-1/3 flex gap-x-3 "><Image className="self-start" priority src={icon} alt="logo" height={50} width={50}></Image>
        ...
        <div className="second sm:text-center my-20">
        ...
        <div className="six flex h-1/2 w-100 justify-between py-20 px-20 leading-7 sm:justify-center sm:items-center sm:text-center sm:gap-x-12 sm:flex-col md:flex-row">
        ...
        <div className="seven flex h-1/2 w-100 justify-between px-20 py-20 leading-7 sm:justify-center sm:items-center sm:text-center sm:gap-x-12 sm:flex-col md:flex-row">
        ...
        <div className="eight flex h-1/2 w-100 justify-between px-20 py-20 leading-7 sm:text-center sm:justify-center sm:items-center sm:gap-x-12 sm:flex-col md:flex-row">
        ...
        <div className="third flex h-1/2 w-100 px-20 py-20 sm:gap-x-12 sm:justify-center sm:items-center justify-between sm:text-center sm:flex-col md:flex-row">
         <Image className="h-auto max-w-md" src={email} alt="logo" width={500} height={500}></Image>
         <p className="font-bold text-3xl">Achieve your marketing goals with <br></br>scalable,<span className="font-normal">personalized email automation.</span> </p>
        </div>
        <div className="fourth flex px-20 py-20  h-1/2 w-100 sm:gap-x-12 sm:justify-center sm:items-center sm:text-center justify-between sm:flex-col md:flex-row" >
        <div className="font-semibold text-3xl">Start your website with Panorama today!  <span className="font-normal text-lg pt-5">
        <br></br>We understand that even the best technology is only as good as the <br></br>people behind it. That&rsquo;s why we offer expert, 24/7 support!
          </span></div>
        <Image src={tabs} alt="logo" height={400} width={400}></Image>
        </div>
        <div className="fifth flex my-20 px-20 h-1/2 w-100 justify-between sm:gap-x-12 sm:justify-center sm:items-center sm:flex-col md:flex-row sm:text-center">
            <Image src={fast} alt="logo" height={400} width={400}></Image>
            <p className="font-semibold text-3xl ">Get started quickly, easily and at a minimal price!<br></br><span className="font-normal text-base py-8 text-left">You can choose from our wide selection of pre-designed themes, or you can create your own extraordinary website and get it up and running instantly!</span></p>
        </div>
        </main>
      </body>
    </>

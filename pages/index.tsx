...
export default function Home({}) {
  return (
    <>
      {/* <Header></Header> */}
      {/* <Layout></Layout> */}
      <header className="h-60 w-100 bg-blue px-20 py-10 text-center">
      ...
      <body>
        ...
        <div className="container flex flex-row bg-white flex-wrap h-96 w-100 ml-7 py-2">
          <div className="bg-white  basis-1/3 flex gap-x-3"><Image src="https://panoramasoftwares.com/assets/images/icons/blue/rocket.svg" alt="logo" height="40" width="40"></Image>
          ...
          <div className="bg-white basis-1/3 flex"  gap-x-2><Image src="https://panoramasoftwares.com/assets/images/icons/blue/settings.svg" alt="logo" height="40" width="40"></Image><div><h3 className="font-semibold pb-2 pt-7">Mobile Application Development
       ...
       <div className="third flex h-1/2 w-100 px-20 py-20 gap-x-12">
        <Image className="h-auto max-w-md" src="https://panoramasoftwares.com/assets/images/icons/svg/email.svg" alt="logo" width={500} height={500}></Image>
        ...
        <Image src="https://panoramasoftwares.com/assets/images/pages/servers/shared-page/vectors/tabs.svg" alt="logo" height={500} width={500}></Image>
        </div>
        <div className="fifth flex px-20 gap-x-12 ">
            <Image src="https://panoramasoftwares.com/assets/images/pages/servers/shared-page/vectors/fast.svg" alt="logo" height={500} width={500}></Image>
            <p className="font-semibold text-2xl mx-40">Get started quickly, easily and at a minimal price!<div className="font-normal text-base py-8 text-left">You can choose from our wide selection of pre-designed themes, or you can create your own extraordinary website and get it up and running instantly!</div></p>
        </div>
        </main>
      </body>
    </>

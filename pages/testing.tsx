...
export default function testing() {
  return (
    ...
    <div className="pl-56">
    <Image src="/Olá - Relaxing.png" alt="logo" width="400" height="400"></Image>
    </div>
    ...
    <div className="pl-20 pt-20 pr-56">
        ...
        <p>Testing is a stand-alone stage in the software development process. During testing, all of the modules are thoroughly cross-verified. Raised bugs are forwarded to the development team for resolution, and the product is only released into the public realm after QA approves it.</p>
        <br></br>
        <p>As a result, after the product has been developed while ensuring the client&rsquo;s requirements, it should be immediately handed over to the Quality Assurance department. When the development team has completed the product in accordance with the requirements document, the company begins testing.</p>
        <br></br>
        <p>Panorama Softwares is a leading QA firm, and we can confidently state one thing based on our experience. Take our advice and don&rsquo;t skimp on professional testing procedures.</p>
        <br></br>
        <p>Software is empowered by testing, which ensures its commercial success. Please do not hesitate to contact us if you have any questions. We will be delighted to assist you. Thank you for taking the time to look around the site, and please keep doing so.</p>

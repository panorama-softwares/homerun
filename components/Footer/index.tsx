...
export default function Footer() {
    ...
    return (
    <div>
        <footer className="text-gray-600 body-font bg-black mt-8">
  <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
    <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
      ...
      <p className="mt-2 text-sm text-gray-500">In panorama software solutions, our goal is innovation, with the aim of leaving 
    ...
    <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          <li className="pb-2">
            <a className="text-gray-600 hover:text-gray-800 ">Website Development</a>
          </li>
          <li className="pb-2">
            <a className="text-gray-600 hover:text-gray-800 ">Mobile Application Development</a>
          </li>
          <li className="pb-2">
            <a className="text-gray-600 hover:text-gray-800 ">Desktop App Development</a>
          </li>
          <li className="pb-2">
            <a className="text-gray-600 hover:text-gray-800 ">Search Engine Optimization</a>
          </li>
          <li className="pb-2">
            <a className="text-gray-600 hover:text-gray-800 ">Business Branding</a>
          </li>
          <li className="pb-2">
            <a className="text-gray-600 hover:text-gray-800 ">Graphics Designing</a>
          </li>
          <li className="pb-2">
            <a className="text-gray-600 hover:text-gray-800 ">Custom Web Solution</a>
          </li>
          <li className="pb-2">
            <a className="text-gray-600 hover:text-gray-800 ">Social Media Marketing</a>
          </li>
        </nav>
      </div>
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
      ...
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          ...
          <li className="pb-6 flex text-white ">
          
          <i className="fa fa-envelope fa-lg" aria-hidden="true" ></i>&nbsp;
            <a className="p">hr@panoramasoftware.in</a>
          </li>
          <li className="pb-6">
            <a className="text-white ">

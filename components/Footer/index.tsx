          ...
          <div className="flex-shrink-0 md:mx-0 mx-auto text-center md:text-left lg:w-1/4 md:w-1/2 w-full px-4 space-x-6">
            ...
            <div className="lg:w-1/4 md:w-1/2 w-full px-4 space-x-6">
              ...
              <nav className="list-none ml-0 ">
                <li className="pb-2">
                  <a className="text-light hover:text-white  hover:underline ">Website Development</a>
                </li>
                <li className="pb-2">
                  <a className="text-light hover:text-white hover:underline">Mobile Application Development</a>
                </li>
                <li className="pb-2">
                  <a className="text-light hover:text-white hover:underline">Desktop App Development</a>
                </li>
                <li className="pb-2">
                  <a className="text-light hover:text-white text-center hover:underline">Search Engine Optimization</a>
                </li>
                <li className="pb-2">
                  <a className="text-light hover:text-white hover:underline">Business Branding</a>
                </li>
                <li className="pb-2">
                  <a className="text-light hover:text-white hover:underline">Graphics Designing</a>
                </li>
                <li className="pb-2">
                  <a className="text-light hover:text-white hover:underline">Custom Web Solution</a>
                </li>
                <li className="pb-2">
                  <a className="text-light hover:text-white hover:underline">Social Media Marketing</a>
                  <a className="text-light hover:text-white hover:underline">Website Development</a>
                </li>
                <li className="pb-2">
                  <a className=" text-light hover:text-white hover:underline">
                  <Link href="/mobile">
                ...
                <li className="pb-2">
                  <a className="text-light hover:text-white hover:underline" >
                    <Link href="/desktop">Desktop App Development</Link></a>
                </li>
                <li className="pb-2">
                  <a className="text-light hover:text-white hover:underline">
                    <Link href="/seo">Search Engine Optimization</Link></a>
                </li>
                <li className="pb-2">
                  <a className="text-light hover:text-white hover:underline ">
                    <Link href="/branding">Business Branding</Link></a>
                </li>
                <li className="pb-2">
                  <a className="text-light hover:text-white hover:underline ">
                    <Link href="/graphic">Graphics Designing</Link></a>
                </li>
                <li className="pb-2">
                  <a className="text-light hover:text-white hover:underline ">
                    <Link href="/customweb">Custom Web Solution</Link></a>
                </li>
                <li className="pb-2">
                  <a className="text-light hover:text-white hover:underline ">
                    <Link href="/social">Social Media Marketing</Link></a>
                </li>
              </nav>
            </div>
            ...
            <div className="lg:w-1/4 md:w-1/2 w-full px-4 space-x-6">
              ...
              <nav className="list-none mb-10 ">
                <li className="pb-2">
                  <a className="text-light hover:text-white hover:underline">Home</a>
                </li>
                <li className="pb-2">
                  <a className="text-light hover:text-white hover:underline">About</a>
                </li>
                <li className="pb-2">
                  <a className="text-light hover:text-white hover:underline">Contact</a>
                </li>
                <li className="pb-2">
                  <a className="text-light hover:text-white hover:underline">Technology</a>
                  <a className="text-light hover:text-white hover:underline ">
                  <Link href="/home">
                    Home</Link></a>
                </li>
